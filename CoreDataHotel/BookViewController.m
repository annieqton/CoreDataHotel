...
- (void)setupTextFields{
    ...
    NSDictionary *viewDictionary = @{@"hotelName": hotelName, @"roomNumber": roomNumber, @"firstNameField": self.firstNameField, @"lastNameField": self.lastNameField, @"emailField": self.emailField};
